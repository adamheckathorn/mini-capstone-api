...
supplier = Supplier.new ({ name: "Amazon", email: "email@test.com", phone_number: "479-305-9290" })
supplier.save
supplier = Supplier.new ({ name: "Walmart", email: "email@test.com", phone_number: "479-305-9290" })
supplier.save
